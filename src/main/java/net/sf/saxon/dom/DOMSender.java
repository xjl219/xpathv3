...
//    private static boolean ignoreNoBindingNamespaces =false;
    private static final ThreadLocal<Boolean> ignoreNoBindingNamespaces = new ThreadLocal<Boolean>(){
    public Boolean initialValue() {
        return false;
    }
};

    public static final void ignoreNoBindingNamespaces(){
        ignoreNoBindingNamespaces.set(true);
    }
    public static final void ignoreNoBindingNamespaces(boolean ignore){
        ignoreNoBindingNamespaces.set(ignore);
    }
    /**
    ...
    public void send() throws XPathException {
        ...
        ignoreNoBindingNamespaces.remove();
    ...
    private String getUriForPrefix(String prefix) {
        ...
        if (prefix.equals("")) {
            return "";
        } else if(ignoreNoBindingNamespaces.get()){
            return "";
